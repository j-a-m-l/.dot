...
hi htmlH1       guifg=#FD071F gui=bold
hi htmlH2       guifg=#FD771F gui=bold
hi htmlH3       guifg=#FDA71F gui=bold
hi htmlH4       guifg=#FDA79F
hi htmlH5       guifg=#CDA79F
hi htmlH6       guifg=#9DA79F
...
" TypeScript theme
source ~/.vim/colors/typescript.vim
...
" Haskell theme
source ~/.vim/colors/succinct_type.vim

" Rust theme
source ~/.vim/colors/the_new_decay.vim
...
" vimwiki TODO {{{1
hi VimwikiHeader1 guifg=#229CFD gui=bold
hi VimwikiHeader2 guifg=#1398BD gui=bold
hi VimwikiHeader3 guifg=#229944 gui=bold
hi VimwikiHeader4 guifg=#235699 gui=bold
hi VimwikiHeader5 guifg=#329769 gui=bold
hi VimwikiHeader6 guifg=#AC9ADA gui=bold
" }}}1
