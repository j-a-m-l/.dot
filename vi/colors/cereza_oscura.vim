...
let g:colors_name="cereza_oscura"
...
hi SpecialKey      guifg=#6009EF               gui=italic
...
" complete menu
hi Pmenu           guifg=#66000F guibg=#000000
hi PmenuSel                      guibg=#808080
hi PmenuSbar                     guibg=#080808
hi PmenuThumb      guifg=#66D90F
...
if has("spell")
    ...
    hi SpellLocal  guisp=#7000F0 gui=undercurl
    hi SpellRare   guisp=#FFFFFF gui=undercurl
endif
hi StatusLine      guifg=#455354 guibg=fg
hi StatusLineNC    guifg=#808080 guibg=#080808
hi StorageClass    guifg=#FD971F               gui=italic
hi Structure       guifg=#0000EF
hi Tag             guifg=#F92672               gui=italic
hi Title           guifg=#ef5939
hi Todo            guifg=#BBBBBB guibg=bg      gui=bold

hi Typedef         guifg=#6609EF
...
hi WildMenu        guifg=#06F9EF guibg=#000000

hi Normal          guifg=#3B3A32 guibg=#1B1D1E
