...
"
command -nargs=1 Wdic call OpenWiktionaryEN(<q-args>)
" Avoid loading this function twice TODO Hace falta?
if exists("wiktionary") || &cp
	finish
endif

let wiktionary = 2

function! OpenWiktionaryEN(keyword)
	echo "Buscando..."
  ...
  "so let it do its thing.
	exe 'silent r!lynx -anonymous -dump -nolist http://en.wiktionary.org/wiki/'.proc_keyword
