...
" TODO Limitar sólo a archivos php
" TODO Limitar sólo a archivos java
" TODO Limitar sólo a archivos js
" TODO Limitar sólo a archivos html
" TODO Limitar sólo a archivos css
" TODO Que coja archivos locales
...
inoremap <C-p> <C-O>:call OpenPhpDoc('<c-r><c-w>')<CR><C-O>:wincmd p<CR>
nnoremap <C-p> :call OpenPhpDoc('<c-r><c-w>')<CR>:wincmd p<CR>
vnoremap <C-p> :call OpenPhpDoc('<c-r><c-w>')<CR>:wincmd p<CR>
