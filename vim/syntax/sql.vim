...
" Added
syn keyword sqlJoins left right inner outer cross natural join straight_join

" Added
syn keyword sqlPrimaryKey primary key
...
if version >= 508 || !exists("did_sql_syn_inits")
  ...
  HiLink sqlJoins	Boolean
  HiLink sqlPrimaryKey	Constant
